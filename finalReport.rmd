...
```{r, echo=FALSE,fig.show="hold", out.width="55%", fig.cap="Linear and Best Subset Model"}
par(mar = c(4, 4, .1, .1))
knitr::include_graphics("Images/ActPredLM.png")
knitr::include_graphics("Images/ActPredBestSubset.png")
```
```{r, echo=FALSE, fig.show="hold", out.width="55%", fig.cap="Lasso and Ridge Model"}
par(mar = c(4, 4, .1, .1))
knitr::include_graphics("Images/ActPredLasso.png")
knitr::include_graphics("Images/ActPredRidge.png")
```
```{r, echo=FALSE, fig.show="hold", out.width="55%", fig.cap="Tree and GAM Model"}
par(mar = c(4, 4, .1, .1))
knitr::include_graphics("Images/ActPredForest.png")
knitr::include_graphics("Images/ActPredGam.png")
```
```{r, echo=FALSE, fig.show="hold", out.width="55%", fig.cap="Boosting and Spline Model"}
par(mar = c(4, 4, .1, .1))
knitr::include_graphics("Images/ActPredBoost.png")
knitr::include_graphics("Images/ActPredSpline.png")
```

These plots look very similar to each other each model appearing to have a similar spread of data points from the perfect prediction line. These plots show that the models we used had a decent ability to predict xYAF. Based on the mean squared error (MSE) of all the models used, ridge regression has the lowest MSE with 33.52. This means that on average, our predicted xYAF has an error of 5.74 yards. 
