...
```{r}
# Random Forest
forestMod <- randomForest(yards_gained ~ ., data = train, importance = TRUE, ntree = 1000)
forestMod
...
```{r}
# Analysis
mseTable <- data.frame(cbind("Linear"=lmMSE, "Logit"=logitMSE, "Lasso"=lassoMSE, "Ridge"=ridgeMSE, "GAM"=gamMSE, "SVM"=svmMSE))
print(mseTable)
```
