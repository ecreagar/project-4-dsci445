...
# puntinfo$hangTime[is.na(puntinfo$hangTime)] <- mean(puntinfo$hangTime, na.rm=TRUE)
...
```{r}
# Analysis
mseTable <- data.frame(cbind("Linear"=lmMSE, "Logit"=logitMSE, "Lasso"=lassoMSE, "Ridge"=ridgeMSE, "GAM"=gamMSE, "SVM"=svmMSE, "Spline"=splineMSE, "Random_Forest"=forestMSE, "Best_Subset"=bestSubsetMSE))
print(mseTable)
```
